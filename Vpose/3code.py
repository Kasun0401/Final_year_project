...
image_path = "C:/Users/RoG/Downloads/Programs/asd.png"
...
switch_button = tk.Button( text="Switch Option", command=switch_code, bg="#4CAF50", fg="white", font=("Arial", 8, "bold"))
switch_button.pack(side="top", padx=4, pady=4)

# Create a "Run Code" button with more customization
run_button = tk.Button( text="Start Monitoring", command=run_current_code, bg="#3498db", fg="white", font=("Arial", 8, "bold"))
run_button.pack(side="top", padx=4, pady=4)

# Create a "Stop Code" button with more customization
stop_button = tk.Button( text="Stop Monitoring", command=stop_current_code, bg="#e74c3c", fg="white", font=("Arial", 8, "bold"))
stop_button.pack(side="top", padx=4, pady=4)

open_predefined_website_button = tk.Button(
    text="Patient Health Readings", command=open_predefined_website, bg="#3498db", fg="white", border=0, font=("Microsoft YaHei UI Light", 8, "bold")
)
open_predefined_website_button.pack(side="top", padx=4, pady=4)



# Create a status label to show the current code
status_label = tk.Label(root, text="Current Option: None", font=("Helvetica", 12),fg="navy", bg="lightgray")
